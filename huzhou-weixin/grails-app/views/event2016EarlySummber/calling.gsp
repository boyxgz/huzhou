...
<body class="fenxiang_bg">
	...
	<div class="fenxiang_txt">
	 <g:set var='nickname' value="${UserInfo.loadUserInfo(beneficiary?.openId)?.nickname }"></g:set>
		${KeyedMessage.findByKey("Calling-Request")?.message?.replace("##",nickname?nickname:'') }
	</div>
